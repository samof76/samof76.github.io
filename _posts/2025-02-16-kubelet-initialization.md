...
3. **IMPORTANT**: Sets up the `kubeDeps.PodConfig`(`pkg/kubelet/kubelet.go: 457`) instance, helps the kubelet to with the following functions:
...
1. [Kubelet](https://github.com/kubernetes/kubernetes/blob/7bfdda4696f78fc789fe91420f7c8609c71002d0/pkg/kubelet/kubelet.go#L1041)
2. [KubeletConfiguration](https://github.com/kubernetes/kubernetes/blob/7bfdda4696f78fc789fe91420f7c8609c71002d0/pkg/kubelet/apis/config/types.go#L82)
3. [Kubelet Dependencies](https://github.com/kubernetes/kubernetes/blob/7bfdda4696f78fc789fe91420f7c8609c71002d0/pkg/kubelet/kubelet.go#L289)
4. [Kubelet Flags](https://github.com/kubernetes/kubernetes/blob/7bfdda4696f78fc789fe91420f7c8609c71002d0/cmd/kubelet/app/options/options.go#L54)
